...
%>
    ...
    <div class="page-header">
        <h1>🏭 Proveedores</h1>
        <p>Registra, edita y elimina los proveedores del sistema</p>
    </div>
        ...
        <div class="form-card">
            ...
            <form action="Proveedores.jsp" method="post">
                ...
                <div class="btn-row">
                    ...
                    <% if (editId > 0) { %>
                        <a href="Proveedores.jsp" class="btn-secondary">✕ Cancelar</a>
                    <% } else { %>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-btns">
                                    ...
                                    <form action="Proveedores.jsp" method="post" style="display:inline;">
                                    ...
                                    <form action="Proveedores.jsp" method="post" style="display:inline;"
                                          onsubmit="return confirm('¿Eliminar al proveedor \'<%= p.getRazon_social() %>\'?\nEsta acción no se puede deshacer.');">
