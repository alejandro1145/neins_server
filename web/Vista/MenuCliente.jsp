                ...
                <div class="product-grid">
                    ...
                    <article class="product-card" data-name="<%= h(nombre.toLowerCase()) %>" data-stock="<%= stock %>" data-id="<%= h(p.get("id")) %>">
                        ...
                        <% String nombreLower = nombre.toLowerCase();
                           String fotoProducto = nombreLower.contains("aguardiente") ? "aguardiente-amarillo.jpg"
                                : nombreLower.contains("poker") ? "poker.jpg"
                                : nombreLower.contains("medellin") || nombreLower.contains("medellín") ? "ron-medellin.jpg"
                                : nombreLower.contains("vino") ? "vino-tinto.jpg"
                                : (nombreLower.contains("whisky") || nombreLower.contains("whiskey") || nombreLower.contains("johnnie") || nombreLower.contains("walker")) ? "whisky-johnnie-walker.jpg"
                                : null;
