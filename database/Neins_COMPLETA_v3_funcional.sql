-- ============================================================
--  NEINS - Base de datos completa v3.1
--  Una Pa' La Sed - Licoreria Premium
--
--  Version limpia para MariaDB/MySQL:
--   - Archivo UTF-8 sin BOM.
--   - Solo trae el usuario administrador inicial.
--   - No trae clientes, fiados ni pagos de ejemplo.
--   - Incluye productos, proveedores, inventario, triggers y vistas.
-- ============================================================
